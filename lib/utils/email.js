...
const sendInvite = email => {
  const invite = {
    ...
    html: `Use this <a href="https://be-human-demo-staging.herokuapp.com">Invite Link</a> to access the admin page. You will need to use the password: ${process.env.EMAILPASSWORD} and this email to login.`,
  };
